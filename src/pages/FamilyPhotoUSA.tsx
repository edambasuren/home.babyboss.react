...
const FamilyPhoto: FC<any> = (): ReactElement => {
  ...
  let album = new AlbumData("usa", "label.jpg", "blue");
  let pg;

  pg = album.addPage(t('Washington'),45,10);
  ...
  pg = album.addPage(t('Syracuse'),45,10);
  ...
  pg = album.addPage(t('Ithaca'),45,10);
  ...
  pg = album.addPage(t('Rochester'),45,10);
  ...
  pg = album.addPage(t('NewYorkCity'),45,5);
